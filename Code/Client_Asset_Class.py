...
file_path = "/Users/dnamas5/Downloads/ITE=EQUITY.csv"
df = pd.read_csv(file_path)

# Load the mapping file
mapping_file_path = "/Users/dnamas5/Downloads/GPAC Master V5 - Client_Asset_Class Mapping.csv"
...
mapping_dict = {
    row[keyword_column]: {
        'GPAC_Level1': row['GPAC_Asset_Class_Level1'],
        'GPAC_Level2': row['GPAC_Asset_Class_Level2'],
        'GPAC_Level3': row['GPAC_Asset_Class_Level3']
    }
...
df[['GPAC_Asset_Class_Level1', 'GPAC_Asset_Class_Level2', 'GPAC_Asset_Class_Level3']] = df.apply(tag_gpac_levels, axis=1)

# Save the updated DataFrame to a new file
output_path = "/Users/dnamas5/Downloads/0611V1.1_TaggedEquity_ClientAssetClass.csv"
